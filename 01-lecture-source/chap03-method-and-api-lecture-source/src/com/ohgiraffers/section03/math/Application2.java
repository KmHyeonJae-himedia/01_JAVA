...
public class Application2 {
    public static void main(String[] args) {
        /* 수업목표 : 사용자 지정 범위의 난수를 발생 시킬 수 있다. */
        /* 난수의 활용
         * Math.random()을 이용해 발생한 난수는 0부터 1까지의 실수 범위의 난수값을 반환한다.
        ...
        System.out.println("10 ~ 15까지의 난수 : " + random3);

        /* 4. -100 ~ 100까지의 난수 발생 */
        int random4 = (int) (Math.random() * 201) - 100;
